...
-- Add the missing exact-draw score matrix entries.
--
-- Safe to run after 007_champion_bonus.sql.
-- Replaces only the shared match-points function; leaderboard rows recalculate
-- through the existing public.leaderboard view without stored point updates.
